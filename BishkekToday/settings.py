...
SECRET_KEY = 'django-insecure-(u&5&d6x1e5pnwjk6z)w2a#6rce!+^^pzw3d4z7&bs6cg*7f0p'
...
WSGI_APPLICATION = 'BishkekToday.wsgi.application'
...
# Правильное определение BASE_DIR (вариант 1)
BASE_DIR = Path(__file__).resolve().parent.parent
